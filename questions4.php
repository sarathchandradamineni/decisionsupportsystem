...
{
	$_SESSION['question16'] = intval($_POST['q16']);
	$_SESSION['question17'] = intval($_POST['q17']);
	$_SESSION['question18'] = intval($_POST['q18']);
	$_SESSION['question19'] = 0;
	$_SESSION['question20'] = 0;
    ...
    <div class="ddr-page">
		...
		<div class="bottompage">
			...
			<div class="questions_div">
			    ...
			    <div class="ques1">
				16) Select the main priority among these while purchasing a vehicle<br>
                <input type="radio" name="q16" value="10"> environmental benefits<br>
                <input type="radio" name="q16" value="3"> Cost of vehicle<br>
                <input type="radio" name="q16" value="8"> refueling cost<br> 
                <input type="radio" name="q16" value="8"> Mileage of the vehicle<br>
				<input type="radio" name="q16" value="0"> performance of the vehicle
				</div>
				
				<div class="ques1">
				17) Do you really take the emissions of the vehicle in to account while purchasing the vehicle?<br>
                <input type="radio" name="q17" value="10"> Yes<br>
                <input type="radio" name="q17" value="0"> No
				</div>
				 
			    <div class="ques1">
				18) If you are motivated towards LNG and LCNG vehicles, what is main reason behind your motivation<br>
                <input type="radio" name="q18" value="10"> Environmental Benifits<br>
                <input type="radio" name="q18" value="8"> Fuel charges<br>
                <input type="radio" name="q18" value="6"> Maintenance  charges<br> 
                <input type="radio" name="q18" value="6"> Safety<br>
				<input type="radio" name="q18" value="0"> No, I am not at all motivated towards LNG and LCNG vehicles  
				</div>
				
			</div>
			<div class="button_next">
			<button id="ddr-widget__form-submit-1200" type="submit" name="submit_button" style="padding: 10px 15px; font-size: 20px; border-radius: 10px; cursor: pointer;"><b>Submit Survey :)</b></button>
			</div>
			</form>
		</div>
    </div>
