...
{
	$_SESSION['name_user'] = $_POST['input_name'];
    $_SESSION['email_user'] = $_POST['input_email'];	
...
function f()
{
	name = document.getElementById('ddr-widget__form-placeholder-1001').value;
	email = document.getElementById('ddr-widget__form-placeholder-1100').value;
	if(name == "")
...
function l()
{
	document.getElementById('ddr-widget__form-placeholder-1001').focus();
}
</script>
<style type="text/css">
    * {
...
<body onload="l()">
<div class="ddr-page-wrapper" style="background-image: url('bgtree.jpg'); background-position: center center; background-repeat: no-repeat; background-attachment: fixed;">
    <div class="ddr-page">
                                    ...
                                    <div class="ddr-widget" style="opacity: 1;">
                                        <div class="ddr-widget__form-wrapper">
											...
											<label class="ddr-widget__form-text-content ddr-widget__form-label" style="color:#1cbd1dff; font-size: 40px; font-family:'Segoe UI', sans-serif;">Name</label>
												...
												<input id="ddr-widget__form-placeholder-1001" name="input_name" placeholder="enter your Name" type="text" maxlength="100" name="202e_form-text" required="" style="border-style: solid;font-size: 12px; border-color: rgb(28, 189, 29); border-radius: 18px;">
												</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ddr-widget">
                                        <div class="ddr-widget__form-wrapper">
                                            <div class="ddr-widget__form-text ddr-widget__form ddr-widget__form-right" style="margin: 0px 10px 30px 125px; border-style: solid; border-width: 0px;">
												...
												<input id="ddr-widget__form-placeholder-1100" name="input_email" placeholder="enter your email" type="email" name="5538_form-text" required="" style="font-size: 12px; border-radius: 18px; border-color: rgb(28, 189, 29);">
												</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="ddr-b35947185f" class="ddr-page-widget ddr-page-widget__form-submit ddr-page-widget-0 ">
                                    <div class="ddr-widget">
                                        <div class="ddr-widget__form-wrapper">
											...
											<button id="ddr-widget__form-submit-1200" type="submit" onclick ="f()" name="submit_button"style="padding: 10px 15px; font-size: 20px; border-radius: 3px; cursor: pointer;">Submit</button>
											</div>
                                        </div>
                                    </div>
                                </div>
